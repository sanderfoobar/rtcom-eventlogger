...
{
    typedef void (*GMarshalFunc_VOID__INT_STRING_STRING_STRING_STRING_STRING) (
            gpointer     data1,
            gint         arg_1,
            gpointer     arg_2,
            gpointer     arg_3,
    ...
    register GMarshalFunc_VOID__INT_STRING_STRING_STRING_STRING_STRING callback;
    ...
    callback = (GMarshalFunc_VOID__INT_STRING_STRING_STRING_STRING_STRING)
